    ...
    def serve_ai_plugin_json():
        plugin = {
            ...
            "description_for_model": (
                "DC Hub provides real-time data center intelligence: "
                "facility search (21,000+ facilities, 170+ countries), "
                "M&A deal tracking (4,000+ deals), construction pipeline data "
    ...
    def serve_mcp_server_card():
        ...
        card = {
            ...
            "description": (
                ...
                "markets, M&A transactions (4,000+ deals tracked), "
            ...
            "use_cases": [
                ...
                "M&A research — track 4,000+ data center M&A deals",
