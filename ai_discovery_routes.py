    ...
    def serve_mcp_server_card():
        ...
        card = {
            ...
            "use_cases": [
                ...
                "M&A research — track 1,400+ data center M&A deals",
            ...
            # differentiating data (DCPI, 300+ markets, 7 US ISOs, 369 GW)
...
instead of trial-and-erroring 81 tools. Deterministic: same intent -> same plan skeleton (schema_version 1,
...
The 81 tools below are what plan_query orchestrates — reach for one directly only when you already know it.

## MCP Tools — what each RETURNS (so an agent can pick without a trial call)
81 tools at https://dchub.cloud/mcp (call tools/list for the canonical, always-current
...
# AUTO-REPAIR: duplicate route '/llms-full.txt' also in ai_agent_discovery.py:510 — review and remove one
    # =========================================================================
