...
# AUTO-REPAIR: duplicate route '/api/v2/infrastructure/hifld/gas-pipelines' also in expanded_infrastructure_api.py:683 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v2/infrastructure/hifld/transmission' also in expanded_infrastructure_api.py:554 — review and remove one
