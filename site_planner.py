...
# AUTO-REPAIR: duplicate route '/api/v1/site-planner/analyze' also in site_planner.py:1487 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/site-planner/compare' also in site_planner.py:1488 — review and remove one
