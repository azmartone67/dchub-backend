...
# AUTO-REPAIR: duplicate route '/api/v1/site-planner/analyze' also in site_planner.py:1449 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/site-planner/compare' also in site_planner.py:1450 — review and remove one
