...
# AUTO-REPAIR: duplicate route '/api/energy-discovery/health' also in energy_auto_discovery.py:641 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/energy-discovery/sync-now' also in energy_auto_discovery.py:652 — review and remove one
