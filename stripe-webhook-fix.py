...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:12718 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:13600 — review and remove one
