...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8039 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8576 — review and remove one
