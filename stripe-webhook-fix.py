...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8123 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8663 — review and remove one
