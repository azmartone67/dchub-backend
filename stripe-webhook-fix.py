...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8806 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9399 — review and remove one
