...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:10363 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10988 — review and remove one
