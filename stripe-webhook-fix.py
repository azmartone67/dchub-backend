...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9211 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9804 — review and remove one
