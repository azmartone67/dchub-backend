...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:12703 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:13585 — review and remove one
