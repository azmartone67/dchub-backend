...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9705 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10318 — review and remove one
