...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:10032 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10645 — review and remove one
