...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14585 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15500 — review and remove one
