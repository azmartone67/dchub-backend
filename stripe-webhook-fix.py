...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8010 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8547 — review and remove one
