...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9488 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10081 — review and remove one
