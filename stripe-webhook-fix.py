...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8029 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8566 — review and remove one
