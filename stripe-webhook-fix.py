...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:13481 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:14382 — review and remove one
