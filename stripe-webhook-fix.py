...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14204 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15105 — review and remove one
