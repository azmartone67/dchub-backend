...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8196 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8736 — review and remove one
