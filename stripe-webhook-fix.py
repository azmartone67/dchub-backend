...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8401 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8941 — review and remove one
