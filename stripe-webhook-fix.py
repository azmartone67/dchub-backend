...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9221 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9814 — review and remove one
