...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8382 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8922 — review and remove one
