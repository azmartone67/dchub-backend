...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14570 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15485 — review and remove one
