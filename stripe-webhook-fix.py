...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8779 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9372 — review and remove one
