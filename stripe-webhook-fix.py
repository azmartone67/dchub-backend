...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:7200 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:7359 — review and remove one
