...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14611 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15526 — review and remove one
