...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14435 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15336 — review and remove one
