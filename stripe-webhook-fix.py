...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:13716 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:14617 — review and remove one
