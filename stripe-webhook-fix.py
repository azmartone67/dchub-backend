...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8067 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8604 — review and remove one
