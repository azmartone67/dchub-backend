...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8151 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8691 — review and remove one
