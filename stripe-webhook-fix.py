...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14294 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15195 — review and remove one
