...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:10040 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10653 — review and remove one
