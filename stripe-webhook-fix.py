...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:10426 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:11051 — review and remove one
