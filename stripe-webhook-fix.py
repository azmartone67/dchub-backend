...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9448 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10041 — review and remove one
