...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9163 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9756 — review and remove one
