...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9267 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9860 — review and remove one
