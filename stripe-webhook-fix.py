...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14554 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15469 — review and remove one
