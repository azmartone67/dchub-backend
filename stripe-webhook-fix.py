...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:10440 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:11065 — review and remove one
