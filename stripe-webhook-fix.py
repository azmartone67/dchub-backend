...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9697 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10310 — review and remove one
