...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8960 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9553 — review and remove one
