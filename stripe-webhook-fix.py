...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:12890 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:13791 — review and remove one
