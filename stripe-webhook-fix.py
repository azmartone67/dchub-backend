...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:13381 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:14282 — review and remove one
