...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:7870 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8407 — review and remove one
