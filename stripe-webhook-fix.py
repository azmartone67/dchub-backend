...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8207 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8747 — review and remove one
