...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8012 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8549 — review and remove one
