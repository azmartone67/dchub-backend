...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8801 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9394 — review and remove one
