...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14533 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15434 — review and remove one
