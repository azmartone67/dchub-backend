...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8113 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8653 — review and remove one
