...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8376 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8916 — review and remove one
