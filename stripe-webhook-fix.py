...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8159 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8699 — review and remove one
