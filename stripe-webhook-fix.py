...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in api_server.py:1025 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:16748 — review and remove one
