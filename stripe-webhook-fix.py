...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9196 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9789 — review and remove one
