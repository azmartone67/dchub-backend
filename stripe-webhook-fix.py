...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:7498 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8035 — review and remove one
