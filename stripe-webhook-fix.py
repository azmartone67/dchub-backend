...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:10086 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10711 — review and remove one
