...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:14397 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:15298 — review and remove one
