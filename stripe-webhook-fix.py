...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:7906 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8443 — review and remove one
