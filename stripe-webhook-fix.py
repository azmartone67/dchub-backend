...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:9262 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:9855 — review and remove one
