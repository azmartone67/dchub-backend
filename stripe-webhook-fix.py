...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:10352 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:10977 — review and remove one
