...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:8114 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8651 — review and remove one
