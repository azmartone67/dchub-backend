...
# AUTO-REPAIR: duplicate route '/api/stripe/webhook' also in main.py:7827 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/stripe/webhook-test' also in main.py:8364 — review and remove one
