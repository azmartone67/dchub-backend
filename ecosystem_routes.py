...
# AUTO-REPAIR: duplicate route '/api/ecosystem' also in ecosystem_routes.py:221 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/ecosystem/integrations' also in ecosystem_routes.py:785 — review and remove one
