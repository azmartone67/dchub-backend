...
SOCIAL_TEMPLATES = [
    {
        ...
        "template": "📊 {market} Data Center Market Update\n\n"
                   ...
                   "👉 {url}\n\n"
                   "{hashtags}\n\n"
                   "Data from DC Hub — tracking 12,650+ facilities across 170+ countries.",
        "category": "markets"
    },
    {
        "type": "tool_showcase",
...
I'm building DC Hub (dchub.cloud), a platform tracking 12,650+ data centers across 170+ countries using AI agents that auto-discover facilities, track M&A deals, and monitor construction pipelines in real-time.
...
DC Hub (dchub.cloud) is a data center intelligence platform providing site selection tools, M&A tracking, and market intelligence for 12,650+ facilities globally.
...
I'm reaching out from DC Hub (dchub.cloud), tracking 12,650+ data center facilities across 170+ countries.
...
- Tracks 12,650+ facilities across 170+ countries
...
def setup_seo_routes(app):
    ...
    def meta_audit():
        ...
        pages = {
            "https://dchub.cloud/": {
                "title": "DC Hub | Data Center Intelligence Platform | 12,650+ Facilities",
                "description": "Track 12,650+ data center facilities across 170+ countries. Real-time capacity, AI-powered site selection, M&A deal tracking, and market intelligence.",
            ...
            "https://dchub.cloud/ai-agents": {
                ...
                "description": "4 AI agents for data center research: Sales intelligence, data enrichment, social media, and ecosystem analysis. Powered by DC Hub's 12,650+ facility database.",
