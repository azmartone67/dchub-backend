...
# AUTO-REPAIR: duplicate route '/api/leads/subscribe' also in main.py:9381 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/leads/capture' also in main.py:9451 — review and remove one
...
def capture_lead():
    ...
    return jsonify({
        ...
        'lead_id': lead_id,
        'access_granted': True
# AUTO-REPAIR: duplicate route '/api/leads/verify/<token>' also in main.py:9531 — review and remove one
    })
...
def verify_lead(token):
    ...
    conn.commit()
    conn.close()
# AUTO-REPAIR: duplicate route '/api/leads/unsubscribe' also in main.py:9556 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/stripe/config' also in main.py:10058 — review and remove one
...
def stripe_config():
    ...
    return jsonify({
        ...
        'prices': {
            'pro_monthly': 299,
# AUTO-REPAIR: duplicate route '/api/stripe/create-checkout' also in main.py:10071 — review and remove one
            'pro_annual': 1990,
            'founding': 99
        }
    })
...
def handle_payment_failed(invoice):
    ...
    conn = get_db()
# AUTO-REPAIR: duplicate route '/api/stripe/subscription' also in main.py:11924 — review and remove one
    c = conn.cursor()
...
def get_plan_features(plan):
    ...
    features = {
        ...
        'founding': {
            ...
            'pdf_reports': -1,
# AUTO-REPAIR: duplicate route '/api/stripe/portal' also in main.py:11994 — review and remove one
            'saved_searches': -1,
            'api_access': True,
            'priority_support': True,
            'founding_badge': True
...
# AUTO-REPAIR: duplicate route '/api/v1/markets/list' also in main.py:12057 — review and remove one
...
def list_markets():
    ...
    conn.close()
# AUTO-REPAIR: duplicate route '/api/v1/markets/<market>' also in main.py:12272 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/markets/compare' also in main.py:12416 — review and remove one
        'stats': {
...
# AUTO-REPAIR: duplicate route '/api/reports/generate' also in main.py:12543 — review and remove one
    conn.close()
...
# AUTO-REPAIR: duplicate route '/api/v1/search' also in main.py:14926 — review and remove one
...
def search_facilities():
    ...
    if query_lower in MARKET_ALIASES:
        ...
        c.execute(f"""
            ...
            ORDER BY confidence DESC, power_mw DESC
            LIMIT %s
# AUTO-REPAIR: duplicate route '/api/agents/health' also in main.py:15071 — review and remove one
        """, (q, q, q, q, limit))
...
# AUTO-REPAIR: duplicate route '/api/agents/enrichment/submit' also in main.py:15080 — review and remove one
    except Exception as e:
        # Fallback generation
...
def get_discovered_facilities():
    ...
    conn.close()
# AUTO-REPAIR: duplicate route '/api/email/track/<email_id>/open.gif' also in main.py:17033 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/email/unsubscribe' also in main.py:17051 — review and remove one
# EMAIL ENDPOINTS
# =============================================================================
...
def email_unsubscribe():
    ...
    """, (f'%{token}%',))
# AUTO-REPAIR: duplicate route '/api/email/stats' also in main.py:17111 — review and remove one
    conn.commit()
    conn.close()
...
# AUTO-REPAIR: duplicate route '/api/email/process' also in main.py:17128 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/email/test' also in main.py:17148 — review and remove one
...
if __name__ == '__main__':
    ...
    if EMAIL_SERVICE_AVAILABLE:
        try:
# AUTO-REPAIR: duplicate route '/api/transactions/refresh' also in main.py:18175 — review and remove one
            email_worker.start()
        except Exception as e:
...
# AUTO-REPAIR: duplicate route '/api/facilities/refresh' also in main.py:18412 — review and remove one
