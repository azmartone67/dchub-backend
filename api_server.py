...
# AUTO-REPAIR: duplicate route '/api/leads/subscribe' also in main.py:8188 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/leads/capture' also in main.py:8258 — review and remove one
...
def capture_lead():
    ...
    return jsonify({
        ...
        'lead_id': lead_id,
        'access_granted': True
# AUTO-REPAIR: duplicate route '/api/leads/verify/<token>' also in main.py:8338 — review and remove one
    })
...
def verify_lead(token):
    ...
    conn.commit()
    conn.close()
# AUTO-REPAIR: duplicate route '/api/leads/unsubscribe' also in main.py:8363 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/stripe/config' also in main.py:8865 — review and remove one
...
def stripe_config():
    ...
    return jsonify({
        ...
        'prices': {
            'pro_monthly': 299,
# AUTO-REPAIR: duplicate route '/api/stripe/create-checkout' also in main.py:8878 — review and remove one
            'pro_annual': 1990,
            'founding': 99
        }
    })
...
def handle_payment_failed(invoice):
    ...
    conn = get_db()
# AUTO-REPAIR: duplicate route '/api/stripe/subscription' also in main.py:10503 — review and remove one
    c = conn.cursor()
...
def get_plan_features(plan):
    ...
    features = {
        ...
        'founding': {
            ...
            'pdf_reports': -1,
# AUTO-REPAIR: duplicate route '/api/stripe/portal' also in main.py:10573 — review and remove one
            'saved_searches': -1,
            'api_access': True,
            'priority_support': True,
            'founding_badge': True
...
# AUTO-REPAIR: duplicate route '/api/v1/markets/list' also in main.py:10636 — review and remove one
...
def list_markets():
    ...
    conn.close()
# AUTO-REPAIR: duplicate route '/api/v1/markets/<market>' also in main.py:10851 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/markets/compare' also in main.py:10986 — review and remove one
        'stats': {
...
# AUTO-REPAIR: duplicate route '/api/reports/generate' also in main.py:11105 — review and remove one
    conn.close()
...
# AUTO-REPAIR: duplicate route '/api/v1/search' also in main.py:12876 — review and remove one
...
def search_facilities():
    ...
    if query_lower in MARKET_ALIASES:
        ...
        c.execute(f"""
            ...
            ORDER BY confidence DESC, power_mw DESC
            LIMIT %s
# AUTO-REPAIR: duplicate route '/api/agents/health' also in main.py:13021 — review and remove one
        """, (q, q, q, q, limit))
...
# AUTO-REPAIR: duplicate route '/api/agents/enrichment/submit' also in main.py:13030 — review and remove one
    except Exception as e:
        # Fallback generation
...
def get_discovered_facilities():
    ...
    conn.close()
# AUTO-REPAIR: duplicate route '/api/email/track/<email_id>/open.gif' also in main.py:14579 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/email/unsubscribe' also in main.py:14597 — review and remove one
# EMAIL ENDPOINTS
# =============================================================================
...
def email_unsubscribe():
    ...
    """, (f'%{token}%',))
# AUTO-REPAIR: duplicate route '/api/email/stats' also in main.py:14657 — review and remove one
    conn.commit()
    conn.close()
...
# AUTO-REPAIR: duplicate route '/api/email/process' also in main.py:14674 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/email/test' also in main.py:14694 — review and remove one
...
if __name__ == '__main__':
    ...
    if EMAIL_SERVICE_AVAILABLE:
        try:
# AUTO-REPAIR: duplicate route '/api/transactions/refresh' also in main.py:15635 — review and remove one
            email_worker.start()
        except Exception as e:
...
# AUTO-REPAIR: duplicate route '/api/facilities/refresh' also in main.py:15872 — review and remove one
