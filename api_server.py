...
# AUTO-REPAIR: duplicate route '/api/leads/subscribe' also in main.py:11895 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/leads/capture' also in main.py:11965 — review and remove one
...
def capture_lead():
    ...
    return jsonify({
        ...
        'lead_id': lead_id,
        'access_granted': True
# AUTO-REPAIR: duplicate route '/api/leads/verify/<token>' also in main.py:12045 — review and remove one
    })
...
def verify_lead(token):
    ...
    conn.commit()
    conn.close()
# AUTO-REPAIR: duplicate route '/api/leads/unsubscribe' also in main.py:12070 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/stripe/config' also in main.py:12572 — review and remove one
...
def stripe_config():
    ...
    return jsonify({
        ...
        'prices': {
            'pro_monthly': 199,
# AUTO-REPAIR: duplicate route '/api/stripe/create-checkout' also in main.py:12585 — review and remove one
...
def handle_payment_failed(invoice):
    ...
    conn = get_db()
# AUTO-REPAIR: duplicate route '/api/stripe/subscription' also in main.py:15400 — review and remove one
    c = conn.cursor()
...
def get_plan_features(plan):
    ...
    features = {
        ...
        'founding': {
            ...
            'pdf_reports': -1,
# AUTO-REPAIR: duplicate route '/api/stripe/portal' also in main.py:15470 — review and remove one
            'saved_searches': -1,
            'api_access': True,
            'priority_support': True,
            'founding_badge': True
...
# AUTO-REPAIR: duplicate route '/api/v1/markets/list' also in main.py:15595 — review and remove one
...
def list_markets():
    ...
    conn.close()
# AUTO-REPAIR: duplicate route '/api/v1/markets/<market>' also in main.py:15823 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/markets/compare' also in main.py:16010 — review and remove one
        'stats': {
...
# AUTO-REPAIR: duplicate route '/api/reports/generate' also in main.py:16137 — review and remove one
    conn.close()
...
# AUTO-REPAIR: duplicate route '/api/v1/search' also in main.py:19053 — review and remove one
...
def search_facilities():
    ...
    if query_lower in MARKET_ALIASES:
        ...
        c.execute(f"""
            ...
            ORDER BY confidence DESC, power_mw DESC
            LIMIT %s
# AUTO-REPAIR: duplicate route '/api/agents/health' also in main.py:19300 — review and remove one
        """, (q, q, q, q, limit))
...
# AUTO-REPAIR: duplicate route '/api/agents/enrichment/submit' also in main.py:19309 — review and remove one
    except Exception as e:
        # Fallback generation
...
def get_discovered_facilities():
    ...
    conn.close()
# AUTO-REPAIR: duplicate route '/api/email/track/<email_id>/open.gif' also in main.py:21692 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/email/unsubscribe' also in main.py:21710 — review and remove one
# EMAIL ENDPOINTS
# =============================================================================
...
def email_unsubscribe():
    ...
    """, (f'%{token}%',))
# AUTO-REPAIR: duplicate route '/api/email/stats' also in main.py:21770 — review and remove one
    conn.commit()
    conn.close()
...
# AUTO-REPAIR: duplicate route '/api/email/process' also in main.py:21787 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/email/test' also in main.py:21807 — review and remove one
...
if __name__ == '__main__':
    ...
    if EMAIL_SERVICE_AVAILABLE:
        try:
# AUTO-REPAIR: duplicate route '/api/transactions/refresh' also in main.py:23208 — review and remove one
            email_worker.start()
        except Exception as e:
...
# AUTO-REPAIR: duplicate route '/api/facilities/refresh' also in main.py:23445 — review and remove one
