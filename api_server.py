...
def get_discovered_facilities():
    ...
    conn.close()
# AUTO-REPAIR: duplicate route '/api/email/track/<email_id>/open.gif' also in main.py:26259 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/email/unsubscribe' also in main.py:26277 — review and remove one
# EMAIL ENDPOINTS
# =============================================================================
...
def email_unsubscribe():
    ...
    """, (f'%{token}%',))
# AUTO-REPAIR: duplicate route '/api/email/stats' also in main.py:26337 — review and remove one
    conn.commit()
    conn.close()
...
# AUTO-REPAIR: duplicate route '/api/email/process' also in main.py:26354 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/email/test' also in main.py:26374 — review and remove one
...
if __name__ == '__main__':
    ...
    if EMAIL_SERVICE_AVAILABLE:
        try:
# AUTO-REPAIR: duplicate route '/api/transactions/refresh' also in main.py:27941 — review and remove one
            email_worker.start()
        except Exception as e:
...
# AUTO-REPAIR: duplicate route '/api/facilities/refresh' also in main.py:28178 — review and remove one
