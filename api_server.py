...
# AUTO-REPAIR: duplicate route '/api/v1/search' also in main.py:11690 — review and remove one
...
def search_facilities():
    ...
    if query_lower in MARKET_ALIASES:
        ...
        c.execute(f"""
            ...
            ORDER BY confidence DESC, power_mw DESC
            LIMIT %s
# AUTO-REPAIR: duplicate route '/api/agents/health' also in main.py:11835 — review and remove one
        """, (q, q, q, q, limit))
...
# AUTO-REPAIR: duplicate route '/api/agents/enrichment/submit' also in main.py:11844 — review and remove one
    except Exception as e:
        # Fallback generation
...
def get_discovered_facilities():
    ...
    conn.close()
# AUTO-REPAIR: duplicate route '/api/email/track/<email_id>/open.gif' also in main.py:13393 — review and remove one
...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/email/unsubscribe' also in main.py:13411 — review and remove one
# EMAIL ENDPOINTS
# =============================================================================
...
def email_unsubscribe():
    ...
    """, (f'%{token}%',))
# AUTO-REPAIR: duplicate route '/api/email/stats' also in main.py:13471 — review and remove one
    conn.commit()
    conn.close()
...
# AUTO-REPAIR: duplicate route '/api/email/process' also in main.py:13488 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/email/test' also in main.py:13508 — review and remove one
...
if __name__ == '__main__':
    ...
    if EMAIL_SERVICE_AVAILABLE:
        try:
# AUTO-REPAIR: duplicate route '/api/transactions/refresh' also in main.py:14391 — review and remove one
            email_worker.start()
        except Exception as e:
...
# AUTO-REPAIR: duplicate route '/api/facilities/refresh' also in main.py:14628 — review and remove one
