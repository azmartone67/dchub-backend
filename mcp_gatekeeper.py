...
TOOL_TIER = {
    ...
    "list_transactions":       Tier.IDENTIFIED,  # 4,000+ deals M&A history
...
TOOL_TEASER = {
    ...
    "list_transactions":      "4,000+ tracked DC M&A deals — buyer, seller, MW, $/kW, date, region.",
...
def _cta_gated(tool: str, current: Tier, required: Tier, args: Optional[Dict] = None) -> str:
    ...
    *concrete price* so the human sees the deal, not the wall.
    ...
    _SOCIAL_PROOF = {
        ...
        "list_transactions":     "4,000+ tracked M&A deals — Pitchbook charges $30K/yr for less",
    }
