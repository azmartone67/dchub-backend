...
<div class="container">
  ...
  <p>You now have access to the largest data center intelligence platform — {canon_facilities} distinct facilities across 170+ countries, updated in real-time.</p>
  ...
  <p>
    ✓ &nbsp;Browse all {canon_facilities} distinct facilities<br>
