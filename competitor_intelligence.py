...
class CompetitorAnalysis:
    ...
    DC_HUB_ADVANTAGES = {
        'facility_count': '12,650+ facilities vs competitors\' 6-12k',
    ...
    COVERAGE_GAPS = [
        ...
        {'competitor': 'DCHawk', 'gap': 'Limited to North America', 'dc_hub_advantage': '170+ countries, 12,650+ facilities'},
    ...
    def get_competitive_position(cls):
        ...
        return {
            ...
            'vs_competitors': {
                'facility_coverage': '12,650+ vs average 8,000',
