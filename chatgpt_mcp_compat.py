...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:9745 — review and remove one
    ...
    if hasattr(mcp_server, 'tool'):
        @mcp_server.tool(
            ...
            description=(
                ...
                "Covers 12,650+ facilities across 170+ countries, M&A transactions "
...
def register_on_raw_server(server_or_tools_dict):
    ...
    if isinstance(server_or_tools_dict, dict):
        server_or_tools_dict["search"] = {
            "description": (
                "Search DC Hub's data center intelligence — 12,650+ facilities, "
