...
PINNED = {
    ...
    "tools_advertised": 86,                   # canonical advertised count == live tools/list (86 as of 2026-09-07: mcp-server #373 added find_sites, the constraints-in/candidates-out siting query)
