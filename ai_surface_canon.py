...
PINNED = {
    ...
    "tools_advertised": 88,                   # canonical advertised count == live tools/list (88 as of 2026-09-07: mcp-server #375 added get_subsea_cables + get_peering_intel — two datasets the server description already advertised)
