...
PINNED = {
    ...
    "tools_advertised": 83,                   # canonical advertised count == live tools/list (83 as of 2026-08-30: +summarize_for_citation — the 10th and last auto-appended tool to be pinned; the live gate served it while PINNED still said 82, which reds test_tool_catalog_length_matches_canon on EVERY branch at once with no commit touching it; 82 as of 2026-07-31: +get_power_availability_timeline, gateway v2.10.0; 81 as of 2026-07-29: +get_hosting_capacity; 80 as of 2026-07-26: +execute_plan; 79 as of 2026-07-20: +get_global_power/get_permitting_intel/plan_query/research_task/simulate_scenario/standing_intent). PINNED fallback; resolve_canon() overrides it with the live count probed from _MCP_BASE (the public gate) so consumers never go stale. /AGENTS.md reads PINNED directly, so keep current. ★MUST equal len(tool_manifest) — tests/test_fix_closure_shell.py asserts it, so a count edit that skips the manifest cannot land.
