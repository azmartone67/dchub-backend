...
PINNED = {
    ...
    "tools_advertised": 83,                   # canonical advertised count == live tools/list (83 as of 2026-08-30: +summarize_for_citation, dchub-mcp-server #264, the citation/licence assembler; 82 as of 2026-07-31: +get_power_availability_timeline)
    ...
    "tool_manifest": [
        ...
        "subscribe_digest", "suggest_reallocation",
        "summarize_for_citation", "unlock_more_data",
        "why_dchub"
    ],
    "tool_names": [
