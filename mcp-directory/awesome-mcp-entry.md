...
```markdown
- [DC Hub Intelligence](https://dchub.cloud/mcp) - Real-time data center intelligence platform. 21,000+ facilities, 38 tools covering M&A transactions, capacity pipeline, energy/grid analytics, site scoring across 300+ markets and 7 ISOs.  🌐 ☁️
```
