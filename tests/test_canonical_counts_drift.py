...
CANONICAL = {
    "tools": 90,        # live tools/list length on the public MCP gate (★2026-09-11: 88 -> 90, dchub-mcp-server feat/pocket-listings-leads adds get_pocket_listings + request_listing_intro; moves with ai_surface_canon.PINNED. ★2026-09-07: 86 -> 88, mcp-server #375 added get_subsea_cables + get_peering_intel)
