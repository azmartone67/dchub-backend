...
ai_discovery_routes.register_discovery_routes. The ai_agent_discovery handler
that read the static file sat on a blueprint main.py never registers, and is
deleted. Those files still read 18,500+ /
