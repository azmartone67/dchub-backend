...
def test_extraction_itself_works():
    ...
    # 2 since 2026-09-13: /api/admin/load-power-plants-live answers 410 and starts
    # nothing, and /api/admin/load-facilities-live answers 410 and runs no loader.
    assert len(sites) >= 2, ('expected >=2 phase12g_loader_async call sites, '
