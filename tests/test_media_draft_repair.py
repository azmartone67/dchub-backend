...
# AUTO-REPAIR: duplicate route '/api/press-releases/digest-<date_slug>' also in main.py:26044 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/press-releases/<slug>' also in main.py:36943 — review and remove one
