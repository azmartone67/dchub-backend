...
# AUTO-REPAIR: duplicate route '/api/press-releases/digest-<date_slug>' also in main.py:26328 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/press-releases/<slug>' also in main.py:37375 — review and remove one
