...
# AUTO-REPAIR: duplicate route '/api/press-releases/digest-<date_slug>' also in main.py:22362 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/press-releases/<slug>' also in main.py:31937 — review and remove one
