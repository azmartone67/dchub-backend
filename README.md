...
- **12,650+ data center facilities** across 170+ countries (search, profile, score, alternatives)
...
The MCP server at `https://dchub.cloud/mcp` exposes **80 tools** for AI agents. See the standalone repo: [azmartone67/dchub-mcp-server](https://github.com/azmartone67/dchub-mcp-server).
