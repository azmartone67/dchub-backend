...
The MCP server at `https://dchub.cloud/mcp` exposes **90 tools** for AI agents (`tools/list` is the canonical, always-current catalog). See the standalone repo: [azmartone67/dchub-mcp-server](https://github.com/azmartone67/dchub-mcp-server).
