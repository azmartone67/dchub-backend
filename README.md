...
- **24,600+ data center facilities** across 170+ countries (search, profile, score, alternatives)
...
- **133,000+ substations** with voltage class + capacity estimates
...
The MCP server at `https://dchub.cloud/mcp` exposes **92 tools** for AI agents (`tools/list` is the canonical, always-current catalog). See the standalone repo: [azmartone67/dchub-mcp-server](https://github.com/azmartone67/dchub-mcp-server).
