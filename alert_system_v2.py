...
# AUTO-REPAIR: duplicate route '/api/v2/alerts' also in main.py:6687 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v2/alerts/<int:alert_id>' also in main.py:6807 — review and remove one
        conn.close()
