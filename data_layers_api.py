...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:14937 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:14956 — review and remove one
