...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:26034 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:26125 — review and remove one
