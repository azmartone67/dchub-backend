...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:24966 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25057 — review and remove one
