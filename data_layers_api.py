...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:23003 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:23094 — review and remove one
