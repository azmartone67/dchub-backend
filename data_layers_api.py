...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:16369 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:16388 — review and remove one
