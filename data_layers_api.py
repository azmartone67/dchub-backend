...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:13787 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:13806 — review and remove one
