...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:26381 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:26472 — review and remove one
