...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:12494 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:12513 — review and remove one
