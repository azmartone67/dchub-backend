...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:14082 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:14101 — review and remove one
