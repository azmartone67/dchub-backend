...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:26509 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:26600 — review and remove one
