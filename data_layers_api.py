...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25000 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25091 — review and remove one
