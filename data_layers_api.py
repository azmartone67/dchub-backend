...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:17928 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:17947 — review and remove one
