...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:13113 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:13132 — review and remove one
