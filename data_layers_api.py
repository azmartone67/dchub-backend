...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:14077 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:14096 — review and remove one
