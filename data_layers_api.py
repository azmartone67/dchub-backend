...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:16943 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:16962 — review and remove one
