...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25178 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25269 — review and remove one
