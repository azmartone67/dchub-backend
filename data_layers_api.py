...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:16220 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:16239 — review and remove one
