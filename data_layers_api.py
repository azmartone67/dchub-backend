...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:14741 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:14760 — review and remove one
