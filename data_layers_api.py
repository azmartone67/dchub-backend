...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:24951 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25042 — review and remove one
