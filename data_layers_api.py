...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:16043 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:16062 — review and remove one
