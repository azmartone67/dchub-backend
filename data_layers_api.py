...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:15041 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:15060 — review and remove one
