...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:13303 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:13322 — review and remove one
