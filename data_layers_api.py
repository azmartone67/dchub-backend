...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:26390 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:26481 — review and remove one
