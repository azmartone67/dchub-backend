...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:29406 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:29497 — review and remove one
