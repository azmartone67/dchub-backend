...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25089 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25180 — review and remove one
