...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:16085 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:16104 — review and remove one
