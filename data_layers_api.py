...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:11815 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:11834 — review and remove one
