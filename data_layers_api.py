...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:24702 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:24793 — review and remove one
