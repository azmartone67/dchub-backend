...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:17173 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:17192 — review and remove one
