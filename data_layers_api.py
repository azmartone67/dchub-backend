...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:12490 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:12509 — review and remove one
