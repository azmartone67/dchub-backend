...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:22415 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:22506 — review and remove one
