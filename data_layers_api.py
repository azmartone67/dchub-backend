...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25450 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25541 — review and remove one
