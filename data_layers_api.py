...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25196 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25287 — review and remove one
