...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25441 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25532 — review and remove one
