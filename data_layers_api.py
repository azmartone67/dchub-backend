...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25422 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25513 — review and remove one
