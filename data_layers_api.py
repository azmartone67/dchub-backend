...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25640 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25731 — review and remove one
