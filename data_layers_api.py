...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:24812 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:24903 — review and remove one
