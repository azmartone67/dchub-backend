...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:25703 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:25794 — review and remove one
