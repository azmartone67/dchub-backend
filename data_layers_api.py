...
# AUTO-REPAIR: duplicate route '/api/v1/lmp/prices' also in main.py:13286 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/stats' also in main.py:13305 — review and remove one
