...
# AUTO-REPAIR: duplicate route '/api/fiber/providers' also in jobs_api.py:478 — review and remove one
@fiber_bp.route('/api/fiber/providers')
def get_providers():
    return jsonify({'success': True, **FiberProviderAPI.get_all_providers()})
# AUTO-REPAIR: duplicate route '/api/fiber/providers/<provider_id>' also in jobs_api.py:482 — review and remove one

@fiber_bp.route('/api/fiber/providers/<provider_id>')
def get_provider(provider_id):
# AUTO-REPAIR: duplicate route '/api/fiber/providers/market' also in jobs_api.py:486 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/fiber/routes' also in jobs_api.py:491 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/fiber/carrier-hotels' also in jobs_api.py:496 — review and remove one
def get_routes():
    provider = request.args.get('provider')
    return jsonify({'success': True, **FiberProviderAPI.get_routes(provider)})

@fiber_bp.route('/api/fiber/carrier-hotels')
# AUTO-REPAIR: duplicate route '/api/fiber/bead-allocations' also in jobs_api.py:502 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/fiber/coverage' also in jobs_api.py:510 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/fiber/summary' also in jobs_api.py:517 — review and remove one
