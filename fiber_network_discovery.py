...
# AUTO-REPAIR: duplicate route '/api/fiber/providers' also in jobs_api.py:458 — review and remove one
@fiber_bp.route('/api/fiber/providers')
def get_providers():
    return jsonify({'success': True, **FiberProviderAPI.get_all_providers()})
# AUTO-REPAIR: duplicate route '/api/fiber/providers/<provider_id>' also in jobs_api.py:462 — review and remove one

@fiber_bp.route('/api/fiber/providers/<provider_id>')
def get_provider(provider_id):
# AUTO-REPAIR: duplicate route '/api/fiber/providers/market' also in jobs_api.py:466 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/fiber/routes' also in jobs_api.py:471 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/fiber/carrier-hotels' also in jobs_api.py:476 — review and remove one
def get_routes():
    provider = request.args.get('provider')
    return jsonify({'success': True, **FiberProviderAPI.get_routes(provider)})

@fiber_bp.route('/api/fiber/carrier-hotels')
# AUTO-REPAIR: duplicate route '/api/fiber/bead-allocations' also in jobs_api.py:482 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/fiber/coverage' also in jobs_api.py:490 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/fiber/summary' also in jobs_api.py:497 — review and remove one
