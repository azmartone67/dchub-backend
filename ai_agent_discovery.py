...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:16335 — review and remove one
...
def serve_llms_full():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:16355 — review and remove one
