...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:31975 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:31995 — review and remove one
# ----- security.txt -----
