...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:19487 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:19507 — review and remove one
# ----- security.txt -----
