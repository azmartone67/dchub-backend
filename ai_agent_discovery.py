...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:21548 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:21568 — review and remove one
...
def serve_security_txt():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:16200 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:16354 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:16355 — review and remove one
        return jsonify({"success": False, "error": str(e)}), 500
