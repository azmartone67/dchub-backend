...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:17896 — review and remove one
...
def serve_security_txt():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:13544 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:13661 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:13662 — review and remove one
        return jsonify({"success": False, "error": str(e)}), 500
