...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:17219 — review and remove one
...
def serve_llms_full():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:17239 — review and remove one
