...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:26044 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:26064 — review and remove one
...
def serve_security_txt():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:19644 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:19798 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:19799 — review and remove one
        return jsonify({"success": False, "error": str(e)}), 500
