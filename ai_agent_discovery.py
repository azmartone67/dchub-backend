...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:29920 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:29940 — review and remove one
# ----- security.txt -----
