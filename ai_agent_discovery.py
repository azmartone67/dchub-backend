...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:26037 — review and remove one
...
# AUTO-REPAIR: duplicate route '/llms-full.txt' also in ai_discovery_routes.py:796 — review and remove one
# ----- llms-full.txt -----
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:26057 — review and remove one
...
def serve_security_txt():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:19637 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:19791 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:19792 — review and remove one
        return jsonify({"success": False, "error": str(e)}), 500
