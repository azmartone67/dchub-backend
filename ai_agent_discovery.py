...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:18792 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:18812 — review and remove one
# ----- security.txt -----
