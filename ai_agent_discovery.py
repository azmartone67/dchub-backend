...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:16455 — review and remove one
...
def serve_llms_full():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:16475 — review and remove one
...
def serve_security_txt():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:12222 — review and remove one
    return response
...
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:12339 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:12340 — review and remove one
    except Exception as e:
        return jsonify({"success": False, "error": str(e)}), 500
