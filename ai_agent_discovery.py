...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:14892 — review and remove one
...
def serve_llms_full():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:14912 — review and remove one
...
def serve_security_txt():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:10678 — review and remove one
    return response
...
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:10795 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:10796 — review and remove one
    except Exception as e:
        return jsonify({"success": False, "error": str(e)}), 500
