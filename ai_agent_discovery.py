...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:31092 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:31112 — review and remove one
# ----- security.txt -----
