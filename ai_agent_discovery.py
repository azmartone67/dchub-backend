...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:18313 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:18333 — review and remove one
