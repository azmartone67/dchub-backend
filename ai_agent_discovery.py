...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:19866 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:19886 — review and remove one
# ----- security.txt -----
