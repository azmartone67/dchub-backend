...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:32370 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:32390 — review and remove one
# ----- security.txt -----
