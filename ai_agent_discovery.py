...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:17859 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:17879 — review and remove one
...
def serve_security_txt():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:13527 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:13644 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:13645 — review and remove one
        return jsonify({"success": False, "error": str(e)}), 500
