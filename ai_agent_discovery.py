...
A2A_AGENT_CARD = {
    ...
    "description": "Data center intelligence platform - 21,000+ facilities, 2,000+ M&A deals, real-time grid data from 7 ISOs, site scoring, market intelligence across 170+ countries.",
    ...
    "skills": [
        ...
        },
        {
            ...
            "description": "Track 2,000+ data center M&A deals, CapEx, and investment deals.",
...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:22412 — review and remove one
...
# AUTO-REPAIR: duplicate route '/llms-full.txt' also in ai_discovery_routes.py:631 — review and remove one
# ----- llms-full.txt -----
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:22432 — review and remove one
...
def serve_security_txt():
    ...
    response.headers['Access-Control-Allow-Origin'] = '*'
    return response
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:16942 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:17096 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:17097 — review and remove one
        return jsonify({"success": False, "error": str(e)}), 500
