...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:30339 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:30359 — review and remove one
# ----- security.txt -----
...
def ai_tracking_recent():
    ...
    try:
        ...
        return jsonify({"success": False, "error": str(e)}), 500
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:23200 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:23201 — review and remove one
