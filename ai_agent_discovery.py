...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:27274 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:27294 — review and remove one
# ----- security.txt -----
...
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:20648 — review and remove one
...
def ai_tracking_recent():
    ...
    try:
        ...
        return jsonify({"success": False, "error": str(e)}), 500
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:20909 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:20910 — review and remove one
