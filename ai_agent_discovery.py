...
A2A_AGENT_CARD = {
    ...
    "description": "Data center intelligence platform - 21,000+ facilities, 1,400+ M&A deals, real-time grid data from 7 ISOs, site scoring, market intelligence across 170+ countries.",
...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:27100 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:27120 — review and remove one
# ----- security.txt -----
...
# AUTO-REPAIR: duplicate route '/api/v1/ai-tracking/stats' also in main.py:20474 — review and remove one
...
def ai_tracking_recent():
    ...
    try:
        ...
        return jsonify({"success": False, "error": str(e)}), 500
# AUTO-REPAIR: duplicate route '/api/v1/discovery' also in main.py:20735 — review and remove one
# AUTO-REPAIR: duplicate route '/ai/discovery' also in main.py:20736 — review and remove one
