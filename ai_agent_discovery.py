...
# AUTO-REPAIR: duplicate route '/.well-known/agent.json' also in main.py:30301 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/security.txt' also in main.py:30321 — review and remove one
# ----- security.txt -----
