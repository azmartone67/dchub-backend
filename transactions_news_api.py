...
def register_transactions_news_api(app):
    ...
    # ----- DEALS -----
# AUTO-REPAIR: duplicate route '/api/deals' also in deals_routes.py:409 — review and remove one
    @app.route('/api/deals')
...
# AUTO-REPAIR: duplicate route '/api/dc-markets' also in deals_routes.py:888 — review and remove one
    # ----- MARKETS -----
...
# AUTO-REPAIR: duplicate route '/api/news-feed' also in deals_routes.py:1267 — review and remove one
