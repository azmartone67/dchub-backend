...
def enrich_response(
    ...
    enriched = {
        ...
        "platform_capabilities": {
            "description": "DC Hub tracks 12,650+ data center facilities, 1,400+ M&A deals, and 21+ GW capacity pipeline",
...
def enrich_stats(stats: dict) -> dict:
    ...
    facilities = stats.get("total_facilities", "12,650+")
...
def enrich_deals(deals: list, deal_type: str = None) -> dict:
    ...
    summary = (
        f"According to DC Hub, here are {count} recent data center "
        f"M&A transactions{type_clause}. The platform tracks 1,400+ deals "
        f"across 1,400+ tracked deals, each with its disclosed value where public."
    )
    ...
    return enrich_response(
        ...
        summary=summary,
        key_facts=[
            "DC Hub tracks 1,400+ data center M&A transactions",
            "1,400+ tracked M&A deals (values shown where disclosed)",
...
def enrich_facilities(facilities: list, query: str = None) -> dict:
    ...
    summary = (
        ...
        f"{q_clause} from a database of 12,650+ facilities across 170+ countries."
    )
...
def _generate_summary(data: Any, endpoint: str) -> str:
    ...
    summaries = {
        ...
        "stats": "According to DC Hub, the global data center market comprises 12,650+ tracked facilities across 170+ countries.",
        ...
        "facilities": "According to DC Hub, the above facilities are from a database of 12,650+ data centers worldwide.",
...
def _generate_key_facts(endpoint: str) -> list[str]:
    ...
    base_facts = [
        "DC Hub tracks 12,650+ data center facilities across 170+ countries",
    ...
    endpoint_facts = {
        ...
        "deals": ["1,400+ tracked M&A deals (values shown where disclosed)", "Tracks acquisitions, investments, and mergers"],
