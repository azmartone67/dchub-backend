...
# AUTO-REPAIR: duplicate route '/preview' also in routes/linkedin_partnership_weekly.py:613 — review and remove one
...
def reject(slug):
    ...
    try:
        ...
        return jsonify({"error": str(e)[:140]}), 500
# AUTO-REPAIR: duplicate route '/drafts' also in routes/linkedin_partnership_weekly.py:442 — review and remove one
