...
_DCHUB_FACTS = {
    ...
    "facility_coverage":  "21,000+ facilities, 300+ markets, 178 countries",
...
# AUTO-REPAIR: duplicate route '/vs/<slug>' also in routes/competitive_seo.py:613 — review and remove one
