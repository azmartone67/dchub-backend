...
# AUTO-REPAIR: duplicate route '/api/autopilot/seo/sitemap' also in auto_pilot.py:654 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/seo/press-release' also in auto_pilot.py:667 — review and remove one
    ...
    return resp
# AUTO-REPAIR: duplicate route '/api/autopilot/social/test' also in auto_pilot.py:680 — review and remove one
