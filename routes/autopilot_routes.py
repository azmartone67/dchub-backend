...
# AUTO-REPAIR: duplicate route '/api/autopilot/status' also in auto_pilot.py:274 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/stats' also in auto_pilot.py:296 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/pending' also in auto_pilot.py:310 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/approve/<item_type>/<item_id>' also in auto_pilot.py:321 — review and remove one
    })
...
# AUTO-REPAIR: duplicate route '/api/autopilot/config' also in auto_pilot.py:330 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/self-learning/status' also in auto_pilot.py:349 — review and remove one
        'ai_extraction': True,
...
# AUTO-REPAIR: duplicate route '/api/autopilot/self-learning/run' also in auto_pilot.py:360 — review and remove one
...
def self_learning_run():
    ...
    try:
# AUTO-REPAIR: duplicate route '/api/autopilot/deep-learning/status' also in auto_pilot.py:371 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/deep-learning/run' also in auto_pilot.py:382 — review and remove one
    try:
...
# AUTO-REPAIR: duplicate route '/api/autopilot/transactions' also in auto_pilot.py:393 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/capacity-pipeline' also in auto_pilot.py:505 — review and remove one
                'avg_confidence': 88.0,
                'last_scan': datetime.now().strftime('%I:%M %p'),
                'source': 'curated'
            }
    ...
    try:
        ...
        return jsonify({
            ...
            'stats': {
                'total_gw': round(total_mw / 1000, 1),
                'total_mw': total_mw,
# AUTO-REPAIR: duplicate route '/api/autopilot/seo/status' also in auto_pilot.py:606 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/seo/run' also in auto_pilot.py:617 — review and remove one
...
def seo_status():
    ...
    try:
        ...
        return jsonify({'error': str(e), 'enabled': False}), 500
# AUTO-REPAIR: duplicate route '/api/autopilot/seo/sitemap' also in auto_pilot.py:628 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/autopilot/seo/press-release' also in auto_pilot.py:641 — review and remove one
...
def seo_sitemap():
    ...
    try:
        ...
        return jsonify({'error': str(e)}), 500
# AUTO-REPAIR: duplicate route '/api/autopilot/social/test' also in auto_pilot.py:654 — review and remove one
