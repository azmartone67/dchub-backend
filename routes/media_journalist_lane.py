...
def _canon_facts() -> dict:
    ...
    try:
        ...
        return {
            "facilities_phrase": cs.facilities_phrase(),
...
# AUTO-REPAIR: duplicate route '/api/v1/media/journalist-lane/registry' also in routes/media_journalist_lane.py:508 — review and remove one
@media_journalist_lane_bp.route(
