...
# ── ROUTES ───────────────────────────────────────────────────────────
# AUTO-REPAIR: duplicate route '/reports/monthly' also in routes/comprehensive_report.py:650 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/reports/monthly' also in routes/comprehensive_report.py:675 — review and remove one
