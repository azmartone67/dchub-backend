...
def _compute_report(year: int | None = None,
    ...
    out: dict = {
        ...
        "vs_proprietary_research": {
            ...
            "we_cover": [
                "Power availability + queue depth (DCPI, 300+ markets, daily)",
...
# ── ROUTES ───────────────────────────────────────────────────────────
# AUTO-REPAIR: duplicate route '/reports/monthly' also in routes/comprehensive_report.py:647 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/reports/monthly' also in routes/comprehensive_report.py:672 — review and remove one
