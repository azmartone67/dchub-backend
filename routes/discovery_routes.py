...
# AUTO-REPAIR: duplicate route '/api/discovery/run' also in api_server.py:2596 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/discovery/status' also in api_server.py:2852 — review and remove one
    ...
    try:
        ...
        if conn:
            try:
                ...
                pass
# AUTO-REPAIR: duplicate route '/api/discovery/facilities' also in api_server.py:2928 — review and remove one
