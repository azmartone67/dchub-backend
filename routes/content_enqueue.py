...
DC Hub isn't. MCP-native, 48 tools, {canon_facilities} distinct facilities, 7 live grid operators, fiber + substations + gas pipelines + water risk — one machine-readable, citable query.
