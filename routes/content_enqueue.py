...
DC Hub isn't. MCP-native, 48 tools, 12,650+ facilities, 7 live grid operators, fiber + substations + gas pipelines + water risk — one machine-readable, citable query.
