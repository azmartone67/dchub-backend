    ...
    try:
        with c.cursor() as cur:
            ...
            cur.execute("""
                ...
                VALUES (%s, %s, 'approved', NOW() ON CONFLICT DO NOTHING, %s)
                RETURNING id
...
DC Hub isn't. MCP-native, 48 tools, 21,000+ facilities, 7 live grid operators, fiber + substations + gas pipelines + water risk — one machine-readable, citable query.
