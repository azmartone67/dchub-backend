...
# AUTO-REPAIR: duplicate route '/report' also in ai_agent.py:374 — review and remove one
...
# AUTO-REPAIR: duplicate route '/dashboard' also in main.py:27739 — review and remove one
