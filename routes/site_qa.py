...
# AUTO-REPAIR: duplicate route '/dashboard' also in main.py:24401 — review and remove one
...
# AUTO-REPAIR: duplicate route '/health' also in main.py:7709 — review and remove one
