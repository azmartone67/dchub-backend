...
# AUTO-REPAIR: duplicate route '/report' also in ai_agent.py:373 — review and remove one
...
# AUTO-REPAIR: duplicate route '/dashboard' also in main.py:23991 — review and remove one
...
# AUTO-REPAIR: duplicate route '/health' also in main.py:7572 — review and remove one
