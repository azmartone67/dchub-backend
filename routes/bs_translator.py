...
CLAIMS = [
    ...
    },
    {
        ...
        "dchub":         "Native Model Context Protocol (MCP) server at /mcp — Claude, GPT, Gemini, Perplexity call it directly. 48 tools, 4,000+ calls in the last 14 days.",
        "proof_url":     "/mcp/tools",
...
<div class="cta">
  ...
  <a href="/mcp/tools">See the 48 MCP tools →</a>
