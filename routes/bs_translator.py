...
CLAIMS = [
    ...
    },
    {
        ...
        "dchub":         "Native Model Context Protocol (MCP) server at /mcp — Claude, GPT, Gemini, Perplexity call it directly. 38 tools, 4,000+ calls in the last 14 days.",
        "proof_url":     "/mcp/tools",
...
<div class="cta">
  ...
  <a href="/mcp/tools">See the 38 MCP tools →</a>
