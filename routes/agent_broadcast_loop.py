...
_TARGETS = [
    ...
    # registry the Kimi/Qwen/GLM agent ecosystem actually browses. Listing
    # submitted + live the same day under the DCHUBCLOUD account; probe the
    # listing page itself (200s for our broadcast UA) like the other
    # registry targets.
    ("modelscope",
