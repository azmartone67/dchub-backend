...
# AUTO-REPAIR: duplicate route '/reports/monthly' also in routes/monthly_trend.py:1228 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/reports/monthly' also in routes/monthly_trend.py:1282 — review and remove one
