...
_RETRIEVED_AT = '2026-07-30T07:22:49Z'
_TIER = 'keyed'
...
_BAKED = [
    ...
    },
    {
        ...
        "confidence": 0.71,
        "rationale": "Route intent → class \"incentives_tax\", lead with get_tax_incentives",
        "executed": [
            {
        ...
        "rejected": [
            {
                "tool": "rank_markets",
                "reason": "A single state was named — the statutory read answers it directly; a national ranking answers a broader question than asked."
            },
            {
                "tool": "analyze_site",
                "reason": "No coordinates were supplied — this is a state-level statutory question, not a site read."
            },
            {
                "tool": "get_market_intel",
                "reason": "Incentive programs are enacted at the state level — the metro market report does not carry the statute detail."
            },
            {
                "tool": "search_facilities",
                "reason": "Scored 3 vs 6 — the deterministic margin favored \"incentives_tax\"."
            }
        ],
        "decisions_total": 4,
        "next_recipe": {
            "prompt": "whats_changed",
            "why": "See what moved in the dataset since this call — the return hook."
        },
        "anon_rejected_shown": 1
    },
    {
        ...
        "confidence": 0.8,
        "rationale": "Route intent → class \"fiber\", lead with get_fiber_intel",
        "executed": [
            {
        ...
        "rejected": [
            {
                ...
                "reason": "The long-haul read covers the metro layer too — the dedicated metro map is a narrower view of the same data."
            },
            {
            ...
            {
                "tool": "analyze_site",
                "reason": "Scored 1.5 vs 7.5 — the deterministic margin favored \"fiber\"."
            }
        ],
        "decisions_total": 6,
        "next_recipe": {
    ...
    },
    {
        ...
        "confidence": 0.47,
        "rationale": "Route intent → class \"capacity_search\", lead with get_retirement_headroom",
        "executed": [
            {
                "tool": "get_retirement_headroom",
                "ms": 469,
        ...
        "rejected": [
            ...
            {
                "tool": "rank_markets",
                "reason": "The intent pointed at a specific capacity search, not an open ranking — the retirement + queue reads answer \"find N MW here\" directly."
            },
            {
                "tool": "analyze_site",
                "reason": "No coordinates or candidate_id were supplied — the search has to SURFACE sites before one can be scored."
            },
            {
                "tool": "get_interconnection_queue",
        ...
        "next_recipe": {
            "prompt": "site_analysis",
            "why": "Analyze the minted candidate site end-to-end — pass its candidate_id for zero transcription drift."
        },
        "anon_rejected_shown": 1
    }
]
