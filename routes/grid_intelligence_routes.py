...
# AUTO-REPAIR: duplicate route '/api/v1/grid-intelligence' also in grid_intelligence_routes_patched.py:402 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/grid-intelligence/<region_id>' also in grid_intelligence_routes_patched.py:580 — review and remove one
