...
_BATCH = [
    ...
    ("auto_spare_capacity", "Spare Capacity (moved)",
     "/spare-capacity — 301 to Capacity Source at /listings#list-capacity",
     ["/spare-capacity"], [], ["view"]),
    ...
    ("auto_pocket_listings", "Capacity Source (legacy stub)",
     "/pocket-listings — Capacity Source landing stub (canonical /listings)",
