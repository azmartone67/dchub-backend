...
# AUTO-REPAIR: duplicate route '/api/v1/weekly/ping' also in main.py:1249 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/weekly/subscribe' also in main.py:1253 — review and remove one
...
def subscribe():
    ...
    return resp, 200
# AUTO-REPAIR: duplicate route '/api/v1/weekly/subscribers' also in main.py:1556 — review and remove one
