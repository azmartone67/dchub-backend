...
# AUTO-REPAIR: duplicate route '/api/v1/weekly/ping' also in main.py:1712 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/weekly/subscribe' also in main.py:1716 — review and remove one
...
def subscribe():
    ...
    return resp, 200
# AUTO-REPAIR: duplicate route '/api/v1/weekly/subscribers' also in main.py:2019 — review and remove one
