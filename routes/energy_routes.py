...
def _register_rankings_routes(rankings_bp, db_pool=None, get_db_connection=None, require_plan=None):
    ...
    # Category index
    # ---------------------------------------------------------------
# AUTO-REPAIR: duplicate route '/api/rankings' also in routes/rankings_routes.py:152 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/rankings/construction' also in routes/rankings_routes.py:170 — review and remove one
    ...
    # ---------------------------------------------------------------
# AUTO-REPAIR: duplicate route '/api/rankings/power' also in routes/rankings_routes.py:277 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/rankings/gas' also in routes/rankings_routes.py:339 — review and remove one
    # ---------------------------------------------------------------
    ...
    def rankings_gas():
        ...
        try:
            ...
            if conn: release_conn(conn)
# AUTO-REPAIR: duplicate route '/api/rankings/fiber' also in routes/rankings_routes.py:396 — review and remove one
