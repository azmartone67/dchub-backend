...
_SEED_CONTACTS = [
    ...
    {"outlet": "Reuters — M&A / Infrastructure",
     ...
     "pitch_style": "data_first",
     "priority": 9,
     "notes": "Greg Roumeliotis / Reuters infra desk. 4,000+ deals tracker angle."},
...
def _generate_pitch(contact: dict, angle: dict) -> dict:
    ...
    if key == "dcpi_shift_to_avoid":
        ...
        lead = (f"Hi {name},\n\n"
                ...
                f"Our database tracks 4,000+ deals in lifetime DC transactions — "
        ...
        lead = (f"Hi {name},\n\n"
                ...
                f"{data.get('calls_30d', 0):,}. Claude and Cursor "
                f"now "
                f"actively use the dataset.\n\n"
