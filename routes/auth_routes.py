...
# AUTO-REPAIR: duplicate route '/api/auth/register' also in api_server.py:612 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/auth/login' also in api_server.py:699 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/auth/google' also in api_server.py:743 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/auth/me' also in api_server.py:872 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/auth/update' also in api_server.py:906 — review and remove one
