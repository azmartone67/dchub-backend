...
# AUTO-REPAIR: duplicate route '/api/v1/transactions' also in deals_routes.py:576 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/pipeline' also in deals_routes.py:665 — review and remove one
# =============================================================================
...
# AUTO-REPAIR: duplicate route '/api/v1/gas-pipelines' also in deals_routes.py:778 — review and remove one
    })
...
_GP_PREVIEW_KEEP = ('id', 'pipeline_type', 'status', 'city', 'state', 'country',
                    'source', 'commodity')
# AUTO-REPAIR: duplicate route '/api/v1/deals' also in deals_routes.py:858 — review and remove one
...
def get_dc_markets():
    ...
    return jsonify({
# AUTO-REPAIR: duplicate route '/api/markets' also in deals_routes.py:905 — review and remove one
        'success': True,
        'markets': markets,
        'count': len(markets),
        'data_source': 'seed'
...
# AUTO-REPAIR: duplicate route '/api/pipeline' also in deals_routes.py:933 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/pipeline/summary' also in deals_routes.py:1035 — review and remove one
    payload = _compute_public_pipeline()
...
def get_pipeline_summary():
    ...
    return jsonify({
        'success': True,
# AUTO-REPAIR: duplicate route '/api/v1/analytics' also in deals_routes.py:1124 — review and remove one
        'total_gw': round(total_mw / 1000, 1),
        'total_mw': round(total_mw, 1),
...
# AUTO-REPAIR: duplicate route '/api/agent/news' also in deals_routes.py:1193 — review and remove one
def _pg_news_select():
...
# AUTO-REPAIR: duplicate route '/api/news/live' also in deals_routes.py:1272 — review and remove one
...
def get_live_news():
    ...
    try:
        ...
        try:
            ...
            _news_result = {
# AUTO-REPAIR: duplicate route '/api/news/sync' also in deals_routes.py:1326 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/news' also in api_fixes.py:150 — review and remove one
    try:
        from auto_sync import sync_news
        saved = sync_news()
        return jsonify({
# AUTO-REPAIR: duplicate route '/api/v1/announcements' also in deals_routes.py:1360 — review and remove one
            'success': True,
