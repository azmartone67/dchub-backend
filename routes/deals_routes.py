...
# AUTO-REPAIR: duplicate route '/api/agent/news' also in deals_routes.py:1192 — review and remove one
def _pg_news_select():
...
# AUTO-REPAIR: duplicate route '/api/news/live' also in deals_routes.py:1271 — review and remove one
...
def get_live_news():
    ...
    try:
        ...
        try:
            ...
            _news_result = {
# AUTO-REPAIR: duplicate route '/api/news/sync' also in deals_routes.py:1325 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/news' also in api_fixes.py:150 — review and remove one
    try:
        ...
        saved = sync_news()
        return jsonify({
# AUTO-REPAIR: duplicate route '/api/v1/announcements' also in deals_routes.py:1359 — review and remove one
            'success': True,
