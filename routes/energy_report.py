...
def _gather_energy_uncached(window: str) -> dict:
    ...
    out = {
        ...
        "data_sources": [
            ...
            "grid status (grid operators on 4 continents: 7 US ISOs + TVA + BPA + IESO) + 43 US utility balancing authorities",
        ],
    }
    ...
    out["vs_proprietary_research"] = {
        ...
        "we_cover": [
            ...
            "Real-time fuel mix + carbon intensity across live grids on 4 continents + 43 US utility BAs",
...
<script type="application/ld+json">{json.dumps({
  ...
  "spatialCoverage": "live grids on 4 continents — 7 US ISOs (+TVA/BPA/IESO), UK, ~12 EU zones, Taiwan, Australia + 43 US utility balancing authorities; live UK/EU/Taiwan/Australia grids (Hydro-Quebec, AESO, Nord Pool) modeled",
...
<p class="lede">Live power and grid intelligence across {total} scored markets and live grids on 4 continents + 43 US utility BAs. Verdict shifts, BUILD/AVOID watch lists, interconnection-queue depth, and live fuel mix — refreshed daily, machine-readable, CC-BY-4.0.</p>
