...
REGISTRY: list[ErrorClass] = [
    ...
    ErrorClass(
        ...
        description=(
            ...
            "  • substations / gas_pipelines  → respective HIFLD/EIA refresh\n"
            "    endpoints.\n"
            "  • facilities / discovered_facilities / transmission_lines →\n"
            "    no autonomous refresh; a breach escalates to a human.\n"
