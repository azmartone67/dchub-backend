...
# SECURITY (2026-07-31): the GET /env-snoop endpoint was DELETED here (route-
# security audit critical). It was unauthenticated and returned, for every env
# var matching .*dchub.*/.*resend.*/.*smtp.*, a preview of the value
# (first 4 + last 2 chars + length) — leaking prefixes and lengths of
# DCHUB_ADMIN_KEY / DCHUB_INTERNAL_KEY / DCHUB_SYNC_KEY and mail credentials.
