...
# AUTO-REPAIR: duplicate route '/drafts' also in routes/partnership_press_template.py:369 — review and remove one
...
def status():
    ...
    try:
        ...
        out["recent"] = []
# AUTO-REPAIR: duplicate route '/preview' also in routes/partnership_press_template.py:256 — review and remove one
