...
# AUTO-REPAIR: duplicate route '/drafts' also in routes/partnership_press_template.py:366 — review and remove one
...
def status():
    ...
    try:
        ...
        out["recent"] = []
# AUTO-REPAIR: duplicate route '/preview' also in routes/partnership_press_template.py:253 — review and remove one
