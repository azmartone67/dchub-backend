...
What we bring: 21,405 tracked facilities globally, 300+ markets scored daily by DCPI, 4,000+ tracked M&A deals, real-time grid intelligence across 10 ISOs. Actively used by Claude and Cursor via MCP, with a growing roster of AI agents connecting.
...
We have 21,405 tracked facilities globally. 300+ markets scored daily by DCPI. 4,000+ M&A deals tracked. We're cited by Claude and Cursor.
...
→ /transactions · 4,000+ historical M&A deals tracked
...
→ /dcpi (300+ markets, daily verdicts)
→ /transactions (4,000+ deals)
...
# AUTO-REPAIR: duplicate route '/drafts' also in routes/partnership_press_template.py:367 — review and remove one
...
def status():
    ...
    try:
        ...
        out["recent"] = []
# AUTO-REPAIR: duplicate route '/preview' also in routes/partnership_press_template.py:254 — review and remove one
