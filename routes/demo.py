...
DEMO_SYSTEM_PROMPT = """You are the DC Hub demo assistant. DC Hub is the data center intelligence platform at https://dchub.cloud — 21,000+ facilities, 170+ countries, real-time grid/fiber/market data via MCP + REST.
