...
def _welcome_html(name: str, plan: str, email: str) -> str:
  ...
  <p style="color:#444;font-size:14px">Your plan unlocks 21,000+ facilities across 170+ countries, DCPI market scores, live grid &amp; fiber data, and 4,000+ tracked M&amp;A deals.</p>
