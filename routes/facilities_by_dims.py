...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:19143 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:19174 — review and remove one
