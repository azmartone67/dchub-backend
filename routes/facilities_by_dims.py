...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:14225 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:14256 — review and remove one
