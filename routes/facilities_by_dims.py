...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:18539 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:18570 — review and remove one
