...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:17009 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:17040 — review and remove one
