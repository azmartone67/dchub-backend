...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:14525 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:14556 — review and remove one
