...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:13491 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:13522 — review and remove one
