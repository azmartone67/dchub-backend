...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:15303 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:15334 — review and remove one
