...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:18814 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:18845 — review and remove one
