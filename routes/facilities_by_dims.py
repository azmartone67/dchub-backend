...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:18571 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:18602 — review and remove one
