...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:19850 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:19881 — review and remove one
