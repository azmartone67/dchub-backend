...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:19111 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:19142 — review and remove one
