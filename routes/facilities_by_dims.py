...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:16071 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:16102 — review and remove one
