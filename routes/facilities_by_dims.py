...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:19536 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:19567 — review and remove one
