...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:15629 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:15660 — review and remove one
