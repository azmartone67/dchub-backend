...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:13050 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:13081 — review and remove one
