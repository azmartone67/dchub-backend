...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:18619 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:18650 — review and remove one
