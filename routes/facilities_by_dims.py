...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:14923 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:14954 — review and remove one
