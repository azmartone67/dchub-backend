...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-market' also in main.py:14942 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/facilities/by-provider' also in main.py:14973 — review and remove one
