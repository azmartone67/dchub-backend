    ...
    with _conn() as c, c.cursor() as cur:
        for name, data in metrics.items():
            try:
                ...
                note_swallowed_write("grid_data", where="iso_uk_elexon._persist_metrics")
                pass
        c.commit()
    return rows
...
# AUTO-REPAIR: duplicate route '/snapshot' also in routes/iso_eu_entsoe.py:379 — review and remove one
...
# AUTO-REPAIR: duplicate route '/dcpi-score' also in routes/iso_eu_entsoe.py:401 — review and remove one
