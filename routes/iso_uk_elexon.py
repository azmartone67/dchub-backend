...
# AUTO-REPAIR: duplicate route '/dcpi-score' also in routes/iso_eu_entsoe.py:920 — review and remove one


@iso_uk_elexon_bp.route("/dcpi-score", methods=["GET"])
def http_dcpi_score():
# AUTO-REPAIR: duplicate route '/health' also in main.py:8540 — review and remove one
