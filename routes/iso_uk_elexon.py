...
# AUTO-REPAIR: duplicate route '/snapshot' also in routes/iso_au_aemo.py:171 — review and remove one
...
# AUTO-REPAIR: duplicate route '/dcpi-score' also in routes/iso_au_aemo.py:182 — review and remove one
