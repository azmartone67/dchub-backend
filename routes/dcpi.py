            ...
            with _conn() as c, c.cursor() as cur:
                ...
                if cur.rowcount == 0:
                    ...
                    cur.execute("""
                        ...
                        VALUES (%s,%s,%s,%s,%s, %s,%s,%s, %s,%s,%s, %s,%s,%s, %s, %s,%s,%s, %s, TRUE, NOW() ON CONFLICT DO NOTHING)
                    """, _vals + (slug,))
                c.commit()
            scored += 1
        except Exception as e:
...
# AUTO-REPAIR: duplicate route '/api/v1/dcpi/lite-recompute' also in main.py:26145 — review and remove one
