...
_USER_RECORDED_CITATIONS = [
    ...
    # summary Perplexity surfaces.
    {
        ...
        "response_text": (
            ...
            "streamable-HTTP MCP server with 29 tools covering 15,000+ facilities, 10 "
    ...
    },
    {
        ...
        "response_text": (
            ...
            "(Model Context Protocol) support — agents can query 15,000+ facilities, "
    ...
    # canonical ChatGPT row from the existing cited-by.html artifact.
    {
        ...
        "response_text": (
            ...
            "AI-driven data center intelligence. It tracks 15,000+ global facilities, "
