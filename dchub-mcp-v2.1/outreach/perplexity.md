# Win-back: Perplexity (last seen 62 days ago, February 26)

**To:** integrations@perplexity.ai
**Subject:** DC Hub MCP — what's new since you last connected

Hi Perplexity team,

Your MCP connection to DC Hub went quiet around February 26. We've shipped a lot since then:
...
curl -X POST https://dchub.cloud/api/v1/dev-signup \
  ...
  -d '{"email":"integrations@perplexity.ai"}'
```
