...
class MCPGateway:
    ...
    def _register_routes(self):
        ...
        @self.app.route("/ai-agents.json", methods=["GET"])
        def serve_ai_agents_json():
            """Dynamic agent manifest — updates based on learned capabilities."""
            self._track_discovery("/ai-agents.json")
            return jsonify(self._generate_ai_agents_json())
    ...
    def _generate_openapi_spec(self) -> dict:
        """Generate OpenAPI 3.1 spec for REST consumers and ChatGPT Actions."""
        return {
            "openapi": "3.1.0",
            "info": {
                "title": "DC Hub Nexus API",
                "description": (
                    "Data center intelligence API — facilities, M&A deals, "
                    "capacity pipeline, market intelligence, news, "
                    "and site evaluation."
                ),
                "version": GATEWAY_VERSION,
                "contact": {"url": self.base_url},
            },
            "servers": [
            ...
            "paths": {
                        ...
                        "parameters": [
                            {
                                "name": "q",
                                "in": "query",
                                "description": "Search query (operator, city, country)",
                                "schema": {"type": "string"},
                            },
                            {
                                "name": "country",
                ...
                "/api/deals": {
                    "get": {
                        ...
                        "responses": {
                            "200": {"description": "M&A transaction list"}
                        },
                    }
                },
                "/api/news": {
                    "get": {
                        "summary": "Latest data center industry news",
                        "operationId": "getNews",
                        "parameters": [
                            {
                                "name": "q",
                ...
                "/api/pipeline": {
                    "get": {
                        "summary": "Capacity pipeline — MW under construction",
                ...
                "/api/market-intel": {
                    "get": {
                        "summary": "Market intelligence for data center regions",
                        "operationId": "getMarketIntel",
                        "parameters": [
                            {
                                "name": "market",
                                "in": "query",
                                "description": "Market name (e.g., Northern Virginia, Frankfurt)",
                                "schema": {"type": "string"},
                            },
                        ],
                        "responses": {
                            "200": {"description": "Market intelligence data"}
                        },
                    }
                },
                "/api/site-evaluate": {
                    "post": {
                        "summary": "Evaluate a site for data center suitability",
                        "operationId": "evaluateSite",
                        "requestBody": {
                            "content": {
                                "application/json": {
                                    "schema": {
                        ...
                        "responses": {
                            "200": {"description": "Site evaluation score"}
                        },
                    }
                },
                "/mcp": {
