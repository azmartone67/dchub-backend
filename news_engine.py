...
# The source-registry heartbeat fires from this run: rows = new articles saved,
# and a failure when any step lands in `errors`. Never from import or exit.
@with_heartbeat("backend-news-engine", rows_key="new_saved")
