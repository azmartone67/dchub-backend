...
# =============================================================================
# AUTO-REPAIR: duplicate route '/api/founding-members' also in main.py:7436 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/map' also in main.py:1879 — review and remove one
# =============================================================================
