...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11010 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11285 — review and remove one
