...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10489 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10764 — review and remove one
