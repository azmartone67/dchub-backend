...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10651 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10926 — review and remove one
