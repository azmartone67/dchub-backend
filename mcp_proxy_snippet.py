...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11410 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11685 — review and remove one
