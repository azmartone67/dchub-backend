...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11580 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11855 — review and remove one
