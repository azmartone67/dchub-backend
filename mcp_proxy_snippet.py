...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10991 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11266 — review and remove one
