...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11394 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11669 — review and remove one
