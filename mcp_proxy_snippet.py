...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10443 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10718 — review and remove one
