...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10925 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11200 — review and remove one
