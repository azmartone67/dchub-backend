...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10915 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11190 — review and remove one
