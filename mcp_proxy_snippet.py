...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11599 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11874 — review and remove one
