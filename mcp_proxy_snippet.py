...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10521 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10796 — review and remove one
