...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10689 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10964 — review and remove one
