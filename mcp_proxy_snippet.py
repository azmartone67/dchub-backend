...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10662 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10937 — review and remove one
