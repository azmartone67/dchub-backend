...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10408 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10683 — review and remove one
