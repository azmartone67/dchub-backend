...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10503 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10778 — review and remove one
