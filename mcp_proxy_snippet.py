...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10698 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10973 — review and remove one
