...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11039 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11314 — review and remove one
