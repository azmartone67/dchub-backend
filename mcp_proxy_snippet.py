...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10897 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11172 — review and remove one
