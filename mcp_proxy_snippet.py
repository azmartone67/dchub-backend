...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11590 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11865 — review and remove one
