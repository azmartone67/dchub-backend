...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11419 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11694 — review and remove one
