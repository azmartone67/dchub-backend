...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10729 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11004 — review and remove one
