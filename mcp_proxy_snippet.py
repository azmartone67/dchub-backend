...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10132 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10407 — review and remove one
