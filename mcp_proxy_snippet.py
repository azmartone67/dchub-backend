...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10533 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10808 — review and remove one
