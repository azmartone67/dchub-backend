...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10738 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11013 — review and remove one
