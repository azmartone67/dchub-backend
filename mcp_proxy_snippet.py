...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10431 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10706 — review and remove one
