...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10547 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10822 — review and remove one
