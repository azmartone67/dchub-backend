...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11192 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11467 — review and remove one
