...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11014 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11289 — review and remove one
