...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10691 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10966 — review and remove one
