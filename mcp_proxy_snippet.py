...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10755 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11030 — review and remove one
