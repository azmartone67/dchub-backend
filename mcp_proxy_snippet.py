...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11064 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11339 — review and remove one
