...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10637 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10912 — review and remove one
