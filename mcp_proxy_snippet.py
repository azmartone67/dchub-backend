...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10714 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10989 — review and remove one
