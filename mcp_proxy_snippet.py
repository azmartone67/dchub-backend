...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11451 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11726 — review and remove one
