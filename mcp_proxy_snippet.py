...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10578 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10853 — review and remove one
