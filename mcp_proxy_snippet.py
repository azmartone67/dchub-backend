...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10970 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11245 — review and remove one
