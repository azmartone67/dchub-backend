...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:11490 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:11765 — review and remove one
