...
# AUTO-REPAIR: duplicate route '/mcp' also in main.py:10624 — review and remove one
# AUTO-REPAIR: duplicate route '/mcp/' also in main.py:10899 — review and remove one
