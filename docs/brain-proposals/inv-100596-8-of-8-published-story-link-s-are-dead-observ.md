...
`https://dchub.cloud/press-release/2026-09-09-google-hyperscale-deals-29b-capital-power-ready-assets -> HTTP 404; https://dchub.cloud/press-release/spp-oklahoma-…` — is enumerated in that doc's rolled-up roster, so closing
