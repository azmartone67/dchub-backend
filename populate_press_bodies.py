#!/usr/bin/env python3
"""
DC Hub — Insert 9 press releases into Neon DB
Run on Replit: python3 populate_press_bodies.py
"""
...
PRESS_RELEASES = [
    {
        "title": canon_text("DC Hub Tracks {canon_facilities} distinct Data Center Facilities Globally"),
        ...
        "meta_description": canon_text("DC Hub now tracks over {canon_facilities} distinct data center facilities globally, covering colocation, hyperscale, and edge deployments across 170+ countries."),
...
def main():
    ...
    cur.close()
    conn.close()
    print(f"\n✅  {inserted} press releases inserted/updated")
