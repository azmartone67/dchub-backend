...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:10307 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:27369 — review and remove one
