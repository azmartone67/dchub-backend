...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:10111 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:26985 — review and remove one
...
def well_known_mcp():
    ...
    try:
        ...
        return jsonify({
            ...
            "name": MCP_SERVER_NAME,
            "version": "2.0.0",
            "description": "Data center intelligence platform with 21,000+ facilities, infrastructure mapping, and water/drought analysis"
        })
