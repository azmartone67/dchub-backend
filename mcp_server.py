...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:11351 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:29625 — review and remove one
