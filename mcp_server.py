...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:9792 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:25922 — review and remove one
