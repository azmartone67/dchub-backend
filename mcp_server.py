...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5322 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:15855 — review and remove one
