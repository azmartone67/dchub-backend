...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:10807 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:28505 — review and remove one
