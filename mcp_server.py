...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5618 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:16218 — review and remove one
