...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:12956 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:36121 — review and remove one
