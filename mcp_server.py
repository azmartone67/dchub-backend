...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:11190 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:29316 — review and remove one
