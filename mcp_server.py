...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:4999 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:15516 — review and remove one
