...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:13000 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:36280 — review and remove one
