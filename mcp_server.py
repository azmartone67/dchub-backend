...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7335 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:19353 — review and remove one
