...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:12317 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:31981 — review and remove one
