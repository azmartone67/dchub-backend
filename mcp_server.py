...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5860 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:16493 — review and remove one
