...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:11778 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:31088 — review and remove one
