...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:6839 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:18206 — review and remove one
