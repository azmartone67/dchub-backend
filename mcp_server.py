...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5144 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:15661 — review and remove one
