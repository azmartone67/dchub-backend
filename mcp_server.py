...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7236 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:19254 — review and remove one
