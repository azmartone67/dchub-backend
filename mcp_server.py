...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7898 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:21433 — review and remove one
