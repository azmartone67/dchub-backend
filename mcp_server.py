...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7038 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:18682 — review and remove one
