...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7359 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:19538 — review and remove one
