...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5563 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:16150 — review and remove one
