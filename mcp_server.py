...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5540 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:16113 — review and remove one
