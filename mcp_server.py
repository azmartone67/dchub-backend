...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:4878 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:14746 — review and remove one
