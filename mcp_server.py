...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:12358 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:32053 — review and remove one
