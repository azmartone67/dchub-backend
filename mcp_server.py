...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7670 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:20528 — review and remove one
