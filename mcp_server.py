...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7871 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:21330 — review and remove one
