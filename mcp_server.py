...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:11204 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:29330 — review and remove one
