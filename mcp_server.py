...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:10270 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:27281 — review and remove one
