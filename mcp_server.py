...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:11598 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:30280 — review and remove one
