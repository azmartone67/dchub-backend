...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:11616 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:30403 — review and remove one
