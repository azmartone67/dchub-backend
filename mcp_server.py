...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:11325 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:29609 — review and remove one
