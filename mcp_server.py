...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5385 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:15918 — review and remove one
