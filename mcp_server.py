...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5554 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:16141 — review and remove one
