...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:11849 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:31250 — review and remove one
