...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7127 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:18814 — review and remove one
