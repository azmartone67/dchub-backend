...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7050 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:18694 — review and remove one
