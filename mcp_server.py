...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7792 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:21077 — review and remove one
