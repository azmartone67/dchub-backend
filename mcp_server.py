...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:10397 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:27473 — review and remove one
