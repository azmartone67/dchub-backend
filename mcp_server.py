...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:6952 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:18596 — review and remove one
