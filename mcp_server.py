...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:9799 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:25929 — review and remove one
