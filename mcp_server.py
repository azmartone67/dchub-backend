...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:9808 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:25961 — review and remove one
