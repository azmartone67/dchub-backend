...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7413 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:20172 — review and remove one
