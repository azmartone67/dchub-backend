...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:5722 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:16337 — review and remove one
