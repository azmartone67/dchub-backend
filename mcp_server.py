...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:6662 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:17937 — review and remove one
