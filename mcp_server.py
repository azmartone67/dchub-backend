...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:12178 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:31746 — review and remove one
