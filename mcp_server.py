...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:7377 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:19760 — review and remove one
