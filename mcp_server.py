...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:10652 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:28242 — review and remove one
