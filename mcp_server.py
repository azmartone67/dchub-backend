...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:6858 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:18273 — review and remove one
