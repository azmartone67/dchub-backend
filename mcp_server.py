...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:6667 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:17958 — review and remove one
