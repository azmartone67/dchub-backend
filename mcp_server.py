...
# AUTO-REPAIR: duplicate route '/mcp/manifest' also in main.py:6848 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp.json' also in main.py:18224 — review and remove one
