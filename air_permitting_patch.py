...
# Flask routes
# ------------------------------------------------------------------
# AUTO-REPAIR: duplicate route '/api/infrastructure/air-permitting/nonattainment' also in main.py:22917 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/infrastructure/air-permitting/monitors' also in main.py:22941 — review and remove one
...
def ap_monitors():
    ...
    return jsonify({"success":True,"count":len(results[:limit]),
                    "data":results[:limit],
                    "elapsed_ms":round((_ap_time.time()-_t0)*1000, 2)})
# AUTO-REPAIR: duplicate route '/api/infrastructure/air-permitting/class1' also in main.py:22965 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/infrastructure/air-permitting/sites' also in main.py:22973 — review and remove one
                    "elapsed_ms":round((_ap_time.time()-_t0)*1000, 2)})
...
def ap_sites():
    ...
    _t0 = _ap_time.time()
# AUTO-REPAIR: duplicate route '/api/infrastructure/air-permitting/score' also in main.py:22981 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/infrastructure/air-permitting/health' also in main.py:23015 — review and remove one
