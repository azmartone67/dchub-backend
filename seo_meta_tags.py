...
TOOL_META = {
    ...
    "transactions": {
        ...
        "og_title": "Data Center Transactions — 4,000+ Deals Since 2019 | DC Hub",
    ...
    "ai-agents": {
        ...
        "description": "4 AI-powered agents for data center research: Sales intelligence, data enrichment, social media analytics, and ecosystem analysis. Ask questions, get instant answers backed by 12,650+ facility database.",
    ...
    "pricing": {
        ...
        "description": "Pricing from $9/month for full access to 12,650+ facilities, Land & Power mapping, AI agents, M&A deal tracker, and API.",
        ...
        "og_description": "Data center intelligence from $9/month. 12,650+ facilities, AI agents, deal tracker, site selection tools.",
        "schema_type": "WebPage"
    },
    "assets": {
        "title": "Data Center Asset Explorer | 12,650+ Global Facilities | DC Hub",
        "description": "Browse and search 12,650+ data center facilities worldwide. Filter by provider, location, power capacity, tier level, and status. Detailed profiles with satellite imagery and infrastructure data.",
        ...
        "og_title": "Asset Explorer — 12,650+ Data Centers | DC Hub",
        "og_description": "Search and compare 12,650+ data center facilities worldwide. Filter by provider, power, tier, and location.",
        "schema_type": "Dataset"
    },
    "ai-inventory": {
        "title": "AI Inventory Analysis | Data Center Supply Intelligence | DC Hub",
        "description": "AI-powered supply analysis across data center markets. Track available capacity, absorption rates, pre-lease status, and inventory trends. Powered by real-time facility data from 12,650+ locations.",
    ...
    "about": {
        ...
        "description": "DC Hub is the comprehensive data center intelligence platform tracking 12,650+ facilities across 170+ countries. Built for hyperscale buyers, investors, and infrastructure professionals. Based in Phoenix, AZ.",
        ...
        "og_description": "Tracking 12,650+ data centers across 170+ countries. Built for hyperscale buyers and infrastructure professionals.",
...
def generate_head_html(meta, page_url="https://dchub.cloud/"):
    ...
    org_schema = {
        ...
        "description": "Data center intelligence platform tracking 12,650+ facilities across 170+ countries.",
        "sameAs": [
