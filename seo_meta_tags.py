...
TOOL_META = {
    ...
    "ai-agents": {
        ...
        "description": "4 AI-powered agents for data center research: Sales intelligence, data enrichment, social media analytics, and ecosystem analysis. Ask questions, get instant answers backed by 15,000+ facility database.",
    ...
    "pricing": {
        ...
        "description": "Pricing from $9/month for full access to 15,000+ facilities, Land & Power mapping, AI agents, M&A deal tracker, and API.",
        ...
        "og_description": "Data center intelligence from $9/month. 15,000+ facilities, AI agents, deal tracker, site selection tools.",
        "schema_type": "WebPage"
    },
    "assets": {
        "title": "Data Center Asset Explorer | 20,000+ Global Facilities | DC Hub",
        "description": "Browse and search 15,000+ data center facilities worldwide. Filter by provider, location, power capacity, tier level, and status. Detailed profiles with satellite imagery and infrastructure data.",
        ...
        "og_description": "Search and compare 15,000+ data center facilities worldwide. Filter by provider, power, tier, and location.",
        "schema_type": "Dataset"
    },
    "ai-inventory": {
        "title": "AI Inventory Analysis | Data Center Supply Intelligence | DC Hub",
        "description": "AI-powered supply analysis across data center markets. Track available capacity, absorption rates, pre-lease status, and inventory trends. Powered by real-time facility data from 15,000+ locations.",
    ...
    "about": {
        ...
        "description": "DC Hub is the comprehensive data center intelligence platform tracking 15,000+ facilities across 170+ countries. Built for hyperscale buyers, investors, and infrastructure professionals. Based in Phoenix, AZ.",
        ...
        "og_description": "Tracking 15,000+ data centers across 170+ countries. Built for hyperscale buyers and infrastructure professionals.",
...
def generate_head_html(meta, page_url="https://dchub.cloud/"):
    ...
    org_schema = {
        ...
        "description": "Data center intelligence platform tracking 15,000+ facilities across 170+ countries.",
        "sameAs": [
