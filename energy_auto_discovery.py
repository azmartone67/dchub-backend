...
# AUTO-REPAIR: duplicate route '/api/energy-discovery/health' also in energy_auto_discovery_pg.py:670 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/energy-discovery/sync-now' also in energy_auto_discovery_pg.py:681 — review and remove one
