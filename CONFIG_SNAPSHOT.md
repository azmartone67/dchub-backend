...
## All other non-secret config (92 vars)
...
- `REDIS_URL` = `redis://default:uMBeYyqirVxEKbySAEtMwQSfuETNTMQN@caboose.proxy.rlwy.net:29436`
- `RENDER_DEPLOY_HOOK_URL` = `https://api.render.com/deploy/srv-d86g7g6gvqtc73dlpojg?key=JNpjRUS3kFc`
- `SHELL` = `/bin/zsh`
- `SHLVL` = `1`
