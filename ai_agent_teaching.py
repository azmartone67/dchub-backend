...
# AUTO-REPAIR: duplicate route '/teach/markets' also in ai_agent_teaching.py:118 — review and remove one
    @ai_teaching_bp.route('/teach/markets', methods=['GET'])
    def teach_markets_route():
        return teach_markets(get_db)
# AUTO-REPAIR: duplicate route '/self/status' also in ai_agent_teaching.py:1451 — review and remove one

    @ai_teaching_bp.route('/self/status', methods=['GET'])
    def self_status_route():
# AUTO-REPAIR: duplicate route '/self/data-freshness' also in ai_agent_teaching.py:1548 — review and remove one
        return self_status(get_db)

    @ai_teaching_bp.route('/self/data-freshness', methods=['GET'])
# AUTO-REPAIR: duplicate route '/self/learning' also in ai_agent_teaching.py:1646 — review and remove one
