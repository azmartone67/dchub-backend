...
WELCOME_SERIES_TEMPLATES = {
    1: {
        ...
        "content": """
            ...
            <p>You've just joined <strong>12,650+ data center professionals</strong> who use DC Hub to make smarter infrastructure decisions.</p>
    ...
    5: {
        ...
        "content": """
            ...
            <ul style="margin: 16px 0 24px 24px; color: #4a4a5a;">
                <li style="margin-bottom: 8px;">Search 12,650+ data centers across 170+ countries</li>
