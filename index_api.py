...
# AUTO-REPAIR: duplicate route '/markets' also in main.py:16729 — review and remove one
...
def admin_config_get():
    ...
    if err: return err
# AUTO-REPAIR: duplicate route '/admin/config' also in index_api.py:756 — review and remove one
