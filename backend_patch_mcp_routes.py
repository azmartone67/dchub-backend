...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:19382 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:19593 — review and remove one
