...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:13222 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:13304 — review and remove one
