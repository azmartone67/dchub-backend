...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:19458 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:19669 — review and remove one
