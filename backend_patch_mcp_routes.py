...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:12128 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:12210 — review and remove one
