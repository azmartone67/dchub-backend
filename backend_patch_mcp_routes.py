...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:17226 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:17437 — review and remove one
