...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:14234 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:14432 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp/server-card.json' also in ai_discovery_routes.py:300 — review and remove one
