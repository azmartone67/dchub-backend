...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:20713 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:20924 — review and remove one
