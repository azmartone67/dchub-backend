...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:19298 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:19509 — review and remove one
