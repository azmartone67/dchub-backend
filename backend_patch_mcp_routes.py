...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:12807 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:12889 — review and remove one
