...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:22386 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:22597 — review and remove one
