...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:20070 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:20281 — review and remove one
