...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:15091 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:15289 — review and remove one
