...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:17544 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:17755 — review and remove one
