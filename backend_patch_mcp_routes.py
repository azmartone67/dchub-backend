...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:17436 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:17647 — review and remove one
