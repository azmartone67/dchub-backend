...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:20861 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:21072 — review and remove one
