...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:12496 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:12578 — review and remove one
