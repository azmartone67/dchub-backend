...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:19279 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:19490 — review and remove one
