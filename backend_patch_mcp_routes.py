...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:20939 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:21150 — review and remove one
