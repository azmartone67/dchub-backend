...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:19792 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:20003 — review and remove one
