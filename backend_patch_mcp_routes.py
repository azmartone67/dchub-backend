...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:18893 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:19104 — review and remove one
