...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:17348 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:17559 — review and remove one
