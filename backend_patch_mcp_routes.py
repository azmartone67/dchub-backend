...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:12934 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:13016 — review and remove one
