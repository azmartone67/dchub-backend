...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:16604 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:16802 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp/server-card.json' also in ai_discovery_routes.py:433 — review and remove one
