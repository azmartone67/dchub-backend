...
SERVER_CARD = {
    ...
    "tools": [
        {"name": "search_facilities", "description": "Search 12,650+ data center facilities worldwide"},
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:17526 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:17737 — review and remove one
