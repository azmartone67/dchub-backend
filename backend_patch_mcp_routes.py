...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:14227 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:14425 — review and remove one
