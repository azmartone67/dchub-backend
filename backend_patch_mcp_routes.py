...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:17860 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:18071 — review and remove one
