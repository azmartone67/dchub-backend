...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:16536 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:16734 — review and remove one
