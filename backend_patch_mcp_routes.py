...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:20946 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:21157 — review and remove one
