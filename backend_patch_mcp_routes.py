...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:19872 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:20083 — review and remove one
