...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:19063 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:19274 — review and remove one
