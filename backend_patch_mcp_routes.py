...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:18592 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:18803 — review and remove one
