...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:15330 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:15528 — review and remove one
