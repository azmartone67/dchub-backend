...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:18384 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:18595 — review and remove one
