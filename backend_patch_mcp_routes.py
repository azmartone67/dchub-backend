...
SERVER_CARD = {
    ...
    "tools": [
        {"name": "search_facilities", "description": canon_text("Search {canon_facilities} distinct data center facilities worldwide")},
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:20163 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:20374 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp/server-card.json' also in ai_discovery_routes.py:533 — review and remove one
