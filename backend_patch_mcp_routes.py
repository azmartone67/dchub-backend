...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:12492 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:12574 — review and remove one
