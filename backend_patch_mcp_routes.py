...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:13542 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:13624 — review and remove one
