...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:21299 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:21510 — review and remove one
...
# AUTO-REPAIR: duplicate route '/.well-known/mcp/server-card.json' also in ai_discovery_routes.py:796 — review and remove one
