...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/analytics' also in main.py:22286 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/mcp/platforms' also in main.py:22497 — review and remove one
