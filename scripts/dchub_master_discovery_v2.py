    ...
    while True:
        ...
        for r in records:
            try:
                ...
                note_swallowed_write("eia_generators", where="dchub_master_discovery_v2.fix_eia_generators")
                conn.rollback()
                continue
    ...
    while True:
        ...
        for feat in features:
            ...
            try:
                ...
                note_swallowed_write("dynamic", where="dchub_master_discovery_v2._load_arcgis_features")
                conn.rollback()
...
def _load_geojson_features(conn, cur, table_name, features):
    ...
    for feat in features:
        ...
        try:
            ...
            note_swallowed_write("dynamic", where="dchub_master_discovery_v2._load_geojson_features")
            conn.rollback()
