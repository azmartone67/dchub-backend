...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:9963 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:9537 — review and remove one
# =====================================================
