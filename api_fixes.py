...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:12846 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:12357 — review and remove one
# =====================================================
