...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:12861 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:12372 — review and remove one
# =====================================================
