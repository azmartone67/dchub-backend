...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:11542 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:11065 — review and remove one
# =====================================================
