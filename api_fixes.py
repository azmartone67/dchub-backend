...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:9560 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:9266 — review and remove one
# =====================================================
