...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:21660 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:20242 — review and remove one
