...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10442 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:9985 — review and remove one
# =====================================================
