...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10615 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:10158 — review and remove one
# =====================================================
