...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:21637 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:20219 — review and remove one
