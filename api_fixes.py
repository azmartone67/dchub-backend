...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in api_server.py:1774 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/news' also in deals_routes.py:1332 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in api_server.py:1722 — review and remove one
# =====================================================
