...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:21814 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:20396 — review and remove one
