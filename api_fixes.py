...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10609 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:10152 — review and remove one
# =====================================================
