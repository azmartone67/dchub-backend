...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:18876 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:18015 — review and remove one
