...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10254 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:9797 — review and remove one
# =====================================================
