...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:21651 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:20233 — review and remove one
