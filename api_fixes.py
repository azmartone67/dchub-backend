...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in api_server.py:1771 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in api_server.py:1719 — review and remove one
# =====================================================
