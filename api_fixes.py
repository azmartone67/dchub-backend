...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:13998 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:13385 — review and remove one
