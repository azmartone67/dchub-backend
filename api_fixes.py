...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:14876 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:14213 — review and remove one
