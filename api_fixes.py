...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10975 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:10518 — review and remove one
# =====================================================
