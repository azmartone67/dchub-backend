...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:11153 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:10685 — review and remove one
# =====================================================
