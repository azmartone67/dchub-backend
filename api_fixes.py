...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:20460 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:19329 — review and remove one
