...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10228 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:9771 — review and remove one
# =====================================================
