...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:14147 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:13534 — review and remove one
