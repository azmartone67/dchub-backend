...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:13057 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:12568 — review and remove one
# =====================================================
