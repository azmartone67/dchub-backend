...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:11548 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:11071 — review and remove one
# =====================================================
