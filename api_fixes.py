...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:12871 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:12382 — review and remove one
# =====================================================
