...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:25619 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:23879 — review and remove one
