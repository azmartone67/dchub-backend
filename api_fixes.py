...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:11011 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:10554 — review and remove one
# =====================================================
