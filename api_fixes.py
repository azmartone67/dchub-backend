...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:12830 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:12341 — review and remove one
# =====================================================
