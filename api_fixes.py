...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:25749 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:24009 — review and remove one
