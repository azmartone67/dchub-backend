...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:25649 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:23909 — review and remove one
