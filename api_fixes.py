...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:11567 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:11090 — review and remove one
# =====================================================
