...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:20733 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:19534 — review and remove one
