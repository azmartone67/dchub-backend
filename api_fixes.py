...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:21352 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:19964 — review and remove one
