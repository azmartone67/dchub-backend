...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:12912 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:12423 — review and remove one
# =====================================================
