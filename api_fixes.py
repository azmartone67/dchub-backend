...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:11424 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:10947 — review and remove one
# =====================================================
