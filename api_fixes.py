...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:21338 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:19950 — review and remove one
