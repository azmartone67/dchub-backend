...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:19930 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:18925 — review and remove one
