...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:13161 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:12658 — review and remove one
