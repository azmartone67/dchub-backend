...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10603 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:10146 — review and remove one
# =====================================================
