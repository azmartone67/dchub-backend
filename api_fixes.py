...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:20514 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:19330 — review and remove one
