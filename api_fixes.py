...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:14660 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:14009 — review and remove one
