...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:11508 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:11031 — review and remove one
# =====================================================
