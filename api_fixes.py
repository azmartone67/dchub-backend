...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:12176 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:11687 — review and remove one
# =====================================================
