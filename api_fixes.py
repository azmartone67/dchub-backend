...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:18624 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:17801 — review and remove one
