...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10611 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:10154 — review and remove one
# =====================================================
