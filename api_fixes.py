...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:21473 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:20085 — review and remove one
