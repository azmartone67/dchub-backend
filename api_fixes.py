...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:14220 — review and remove one
...
# =====================================================
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:13607 — review and remove one
