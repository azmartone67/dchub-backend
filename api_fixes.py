...
# AUTO-REPAIR: duplicate route '/api/v1/facilities' also in main.py:10137 — review and remove one
...
# AUTO-REPAIR: duplicate route '/api/v1/stats' also in main.py:9680 — review and remove one
# =====================================================
