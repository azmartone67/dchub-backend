...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:14137 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:3720 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:14126 — review and remove one
