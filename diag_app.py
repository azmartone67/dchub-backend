...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:23854 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:7900 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:23843 — review and remove one
