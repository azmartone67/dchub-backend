...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:23561 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:7718 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:23550 — review and remove one
