...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:14363 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:3839 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:14352 — review and remove one
