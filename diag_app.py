...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:26630 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:8584 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:26619 — review and remove one
