...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:15383 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:4163 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:15372 — review and remove one
