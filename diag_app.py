...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:23845 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:7891 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:23834 — review and remove one
