...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:11931 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in index_api.py:516 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:11920 — review and remove one
