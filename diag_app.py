...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:14191 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:3746 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:14180 — review and remove one
