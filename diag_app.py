...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:14469 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:3855 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:14458 — review and remove one
