...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:23973 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:7917 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:23962 — review and remove one
