...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:14060 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:3720 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:14049 — review and remove one
