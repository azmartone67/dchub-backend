...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:23668 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:7746 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:23657 — review and remove one
