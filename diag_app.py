...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:23536 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:7693 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:23525 — review and remove one
