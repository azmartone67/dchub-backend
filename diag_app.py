...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:15941 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:4380 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:15930 — review and remove one
