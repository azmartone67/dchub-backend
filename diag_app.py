...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:14048 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:3708 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:14037 — review and remove one
