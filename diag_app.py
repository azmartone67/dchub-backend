...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:14264 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:3819 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:14253 — review and remove one
