...
# AUTO-REPAIR: duplicate route '/api/health' also in main.py:14052 — review and remove one
# AUTO-REPAIR: duplicate route '/health' also in main.py:3712 — review and remove one
# AUTO-REPAIR: duplicate route '/' also in main.py:14041 — review and remove one
